...
router.get(
    "/branch/:branchId/sub-branch/:subBranchId",
    branchYearController.getBranchYearsByBranchIdForSubBranchId
);
router.get(
    "/branch/:branchId/academic-year/:academicYearId",
    branchYearController.getBranchYearByAcademicYearIdAndBranchId
);
...
router.patch(
    "/munaqasyah",
    branchYearController.patchBranchYearMunaqasyahStatus
);
router.patch(
    "/munaqasyah/:branchYearId/sub-branch/",
    branchYearController.patchSubBranchMunaqasyahStatus
);
